...
export default function CryptoSaving(props: any) {
    ...
    return (
        <div className='w-screen lg:w-full h-screen pt-8 lg:pt-16 px-4 lg:px-10 overflow-auto'  >
            {show ?
                <>
                    ...
                    <div className='w-full h-auto flex flex-col bg-white rounded-md my-8 lg:pb-0 pb-28 px-2 lg:px-6' >
                        <div className='lg:w-full dashboardslide w-auto overflow-x-auto flex flex-row py-10 ' >
            ...
            :
                <div className='w-full h-full flex justify-center items-center lg:mt-0 -mt-12' > 
                    <lottie-player
                    id="firstLottie"
                    ref={ref}
                    autoplay
                    ...
                    loop
                    mode="normal"
                    src="https://assets4.lottiefiles.com/packages/lf20_0qvqjlcc.json"
