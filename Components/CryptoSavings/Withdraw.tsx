    ...
    return (
        <div className='lg:w-auto w-full h-auto px-6 py-3 rounded bg-white' >
            ...
            <div className='w-full flex flex-col justify-center items-center py-1' >
                <p className='font-Inter-SemiBold text-xs' >Withdraw From Savings - 
                    {coinType === 'BTC' 
                        ?
                            ' Bitcoin':
                        coinType === 'ETH' ?
                ...
                <div className='w-full flex flex-col ' >
                    ...
                    <div className='w-full flex flex-row' >
                        <button  onClick={()=> NextPage()} className='w-full py-4 my-6 mr-2 font-Inter-Medium bg-heritagebutton rounded text-xs text-white' >Withdraw As Crypto</button>
                        <button  onClick={()=> NextPage()} className='w-full border-heritagebutton text-heritagebutton py-4 my-6 ml-2 font-Inter-Medium rounded text-xs border ' >Withdraw As FIAT</button>
                    </div>
                </div>
            </div>
        </div>
