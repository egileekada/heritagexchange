...
export default function SecondFeature() {
    return (
        <div className='w-full flex flex-col justify-center items-center py-14' >
            <p style={{color:'#050505'}} className='font-Inter-Bold text-3xl' >Features we’ve built just <span style={{color:'#091BAAF2'}} className='font-Inter-Medium' >for you</span></p>
            <div className='w-full flex flex-col py-8 justify-center items-center' >
                <div className='w-full flex flex-row justify-center items-center' >
                    <div style={{backgroundColor:'#F8F9FF'}} className='w-72 py-8 px-4 rounded-md m-2' >
                ...
                <div className='w-full flex flex-row justify-center items-cente' >
                    <div style={{backgroundColor:'#F8F9FF'}} className='w-72 py-8 px-4 rounded-md m-2' >
