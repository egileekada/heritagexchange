...
export default function CryptoSaving() {
    ...
    return (
        <div className='w-full h-screen pt-16 px-10 overflow-auto'  >
            ...
            <div className='w-full h-auto flex flex-col bg-white rounded-md my-8 px-6' >
                <div className='w-full flex flex-row py-10 ' >
                    <div style={{backgroundColor:'#1526A7'}} className='relative w-full rounded-md text-white ' >
                        <img src='/assets/images/CryptoBg.png' style={{width: '106px'}} className=' absolute h-full z-20 right-0 ' />
                        <div className='w-full flex flex-col px-6 py-3 pb-6 rounded-md' > 
                            ...
                            <p className='font-Inter-Medium text-sm mt-2 ' >Bitcoin Balance</p>
                            <p className='font-Inter-Bold my-1 text-2xl'>123,301 BTC</p>
                            <p className='font-Inter-Regular text-xs mt-1 '>$5,804,826,128</p>
                        </div>
                    </div>
                    <div style={{backgroundColor:'#111E7E'}} className='relative w-full rounded-md text-white ml-8' >
                        <img src='/assets/images/CryptoBg.png' style={{width: '106px'}} className=' absolute h-full z-20 right-0 ' />
                        <div className='w-full flex flex-col px-6 py-3 pb-6 rounded-md' > 
                            <div className='w-full flex flex-row' >
                                <div className='w-full flex flex-1' />
                            ...
                            <p className='font-Inter-Medium text-sm mt-2 ' >Ethereum Balance</p>
                            <p className='font-Inter-Bold my-1 text-2xl'>23,301 ETH</p>
                            <p className='font-Inter-Regular text-xs mt-1 '>$75,111,472</p>
                        </div>
                    </div>
                    <div style={{backgroundColor:'#1B2364'}} className='relative w-full rounded-md text-white ml-8' >
                        <img src='/assets/images/CryptoBg.png' style={{width: '106px'}} className=' absolute h-full z-20 right-0 ' />
                        <div className='w-full flex flex-col px-6 py-3 pb-6 rounded-md' > 
                            <div className='w-full flex flex-row' >
                                <div className='w-full flex flex-1' />
                            ...
                            <p className='font-Inter-Medium text-sm mt-2 ' >USDT Balance</p>
